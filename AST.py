...
class FunctionParameter(Expression):
    def __init__(self, name: str = None, value_type: str = None) -> None:
        self.name = name
...
class ForStatement(Statement):
    def __init__(self, var_declaration: LetStatement = None, condition: Expression = None, action: Expression = None, body: BlockStatement = None) -> None:
